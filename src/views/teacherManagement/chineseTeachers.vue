<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" style="width: 100%;">
			...
			<el-table-column prop="sex" label="email/skype/QQ" min-width="180" :formatter="formatSex" >
			</el-table-column>
			<el-table-column prop="age" label="工资" width="120" >
			</el-table-column>
			<el-table-column prop="birth" label="所属代理" width="180">
			</el-table-column>
			<el-table-column prop="addr" label="上线日期" width="180">
			</el-table-column>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="email/skype/QQ" prop="email/skype/QQ">
				...
				<el-form-item label="所属代理" prop="agency">
					<el-select v-model="editForm.agency" placeholder="请选择活动区域">
						<el-option label="区域一" value="shanghai"></el-option>
						<el-option label="区域二" value="beijing"></el-option>
					</el-select>
				</el-form-item>
    ...
    <!-- 新增界面 -->
  	<el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="所属代理" prop="agency">
					<el-select v-model="addForm.agency" placeholder="请选择活动区域">
						<el-option label="区域一" value="shanghai"></el-option>
						<el-option label="区域二" value="beijing"></el-option>
					</el-select>
				</el-form-item>
